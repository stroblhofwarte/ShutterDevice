...
namespace ASCOM
{
    class Program
    {
        static void Main(string[] args)
        {
...
#if UseChooser
            // choose the device
            string id = ASCOM.DriverAccess.FilterWheel.Choose("ASCOM.ArduinoFw.FilterWheel");
            ...
            ASCOM.DriverAccess.FilterWheel device = new ASCOM.DriverAccess.FilterWheel("ASCOM.ArduinoFw.FilterWheel");
#endif
