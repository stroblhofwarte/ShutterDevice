...
; Generated by Othmar Ehrhardt on 29.10.2020 (UTC)
;
[Setup]
...
OutputDir="."
OutputBaseFilename="ArduinoFW Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\FilterWheel\ArduinoFW"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\FilterWheel\ArduinoFW"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\_develop\ArduinoShutterAsFwDriver\bin\Release\ASCOM.ArduinoFw.FilterWheel.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
; Source: "C:\_develop\ArduinoShutterAsFwDriver\README.txt"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.ArduinoFw.FilterWheel.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.ArduinoFw.FilterWheel.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.ArduinoFw.FilterWheel.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.ArduinoFw.FilterWheel.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.ArduinoFw.FilterWheel.dll"""; Flags: runhidden 64bit; Check: IsWin64
